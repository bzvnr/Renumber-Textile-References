...
/*
  ...
  objects from the arrays seen in formatCheck(). The other part is that formatChecks'
...
/*
  ...
  or "PASS" if formatCheck passes
*/
function formatCheck(text, ignoreConfirmCode) {
